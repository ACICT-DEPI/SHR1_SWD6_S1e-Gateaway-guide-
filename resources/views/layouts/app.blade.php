...
<head>
    ...
    <title>{{ config('app.name', 'Gateaway Guide') }}</title>
...
<body>
                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <ul class="nav">
                                ...
                                @auth()
                                <li><a href="{{ route('traveling.cart.show') }}">@lang('message.Cart')</a></li>
                                @endauth
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                <p>@lang('message.Copyright')<a href="#">@lang('message.Mohamed S.')</a>@lang('message.Company')
                <br>@lang('message.Design')<a href="https://templatemo.com" target="_blank" title="free CSS templates">@lang('message.M')</a> @lang('message.Distribution')<a href="https://themewagon.com" target="_blank" >@lang('message.Mohamed')</a></p>
                </div>
            </div>
        </div>
    </footer>
