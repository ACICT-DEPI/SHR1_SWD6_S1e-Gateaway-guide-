...
@section('content')
    ...
    <div class="page-heading">
        <div class="container">
            <div class="row">
                <div class="col-12"> <!-- تعديل إلى col-12 لتأخذ المساحة الكاملة على الشاشات الصغيرة -->
                    <h2>My Cart</h2>
                </div>
            </div>
        </div>
    ...
    <div class="container cart-process">
        <!-- Display number of days -->
        @if (session('cart'))
            <table class="table table-responsive" style="margin: 5%;"> <!-- إضافة table-responsive -->
                <thead>
                    <tr>
                        <th>Days</th>
                        <th>Action</th>
            ...
            <form action="{{route('traveling.cart.send.tourGuide')}}" method="POST">
                ...
                {{-- <div id="tour-guide-section" style="margin-top: 30px;">
                    ...
                    <table class="table table-striped table-bordered table-responsive"> <!-- إضافة table-responsive -->
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Email</th>
                ...
                <div id="tour-guide-section" style="margin-top: 30px;width: 111%;">
                    <h4>Select a Tour Guide</h4>

                    <!-- Table for displaying tour guides -->
                    <div class="table-responsive"> <!-- Ensure this div wraps the table -->
