                                ...
                                <div class="owl-cites-town owl-carousel">
                                    @if ($landmark)
                                        ...
                                        @foreach ($landmark->images as $image)
                                            <img class="img" src="{{ asset('assets/images/' . $image->name) }}" alt="">
                                        @endforeach
                                    @else
                    ...
                    @if ($landmark->images->isNotEmpty())
                        @foreach ($landmark->images as $image)
                            <div class="col-sm-12 col-md-6 col-lg-4">
                                <img class="shadow rounded mb-4 gallery-img"
                                    src="{{ asset('assets/images/' . $image->name) }}" alt="{{ $landmark->name }}">
                            </div>
                        @endforeach
                    @else
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="section-heading">
                            <h2>Discover More About Our City</h2>
