...
class TravelingController extends Controller
{
    ...
    public function showLandmark($id)
    {
        ...
        $landmarksCount = LandmarksImages::select()->where('landmark_id', $id)->count();

        return view('traveling.landmark', compact('landmark', 'landmarkImages', 'categories', 'landmarksCount'));
    }
}
